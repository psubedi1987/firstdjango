...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        elem = driver.find_element(By.XPATH,'/html/body/div/div/div[1]/ul/li[3]/a').click()
        time.sleep(8)
        try:
            elem = driver.find_element(By.XPATH,'/html/body/div/div/div[2]/ul/li[1]/a')

            print ("Test passed-Author List Displayed")
            assert True
        except NoSuchElementException:
            self.fail("Author List does not appear - test failed")
